...
$user = $database->show_single('users', $id);
...
if (isset($_POST['submit'])) {
    ...
    if (empty($name)) {
        ...
        $result = $database->email_validation('users', $email, $id);
        ...
        if ($result) {
            ...
            $is_updated = $database->update('users', $data, $id);
            
            $is_updated ? $success = SUCCESS : $error = FAILURE;
        } else {
